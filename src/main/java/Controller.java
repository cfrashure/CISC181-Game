...
public class Controller {
    ...
    public GameS22 setUpGameModel(){
        ...
        piecesTeamA.add(new PieceBuzz('B',"Blu",0,0,
                true,false,true));
        piecesTeamA.add(new PieceSpanishBuzz('S',"Blu",0,0,
                true,false,true));
        piecesTeamA.add(new PieceBlueHen('H',"Blu",0,
                0,false,true));
        piecesTeamA.add(new PieceEvilMinion('E',"Blu",0,
                0,0,false, true));
        piecesTeamA.add(new Rabbid('R',"Blu",0,0,0,
                0,false,true, false));
        ...
        piecesTeamB.add(new PieceBuzz('B',"Red",0,0,
                true,false,true));
        piecesTeamB.add(new PieceSpanishBuzz('S',"Red",0,0,
                true,false,true));
        piecesTeamB.add(new PieceEvilMinion('E',"Red",0,
                0,0,false, true));
        piecesTeamB.add(new Rabbid('R',"Red",0,0,0,
                0,false,true, false));
        // Create a team object
    ...
    public void carryOutAction (int fromRow, int fromColumn, int toRow, int toColumn, char actionType){
        if (actionType == 'A'){
            ...
            System.out.print("*");
            ActionHuddle actHuddle = new ActionHuddle(game, viewer.getfromRow(), viewer.getfromColumn(), viewer.gettoRow(), viewer.gettoColumn());
            actHuddle.performAction();
        }
    }
